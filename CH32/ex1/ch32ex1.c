// This program demonstrates functions returning a value by passing three floating-point numbers and calculating the average of the three.
...
float gradeAve(float test1, float test2, float test3)
{
    ...
    return(localAverage); // returns the result to main
};